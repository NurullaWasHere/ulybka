...
const settings = [{name: "Основное", image: "/user.png"}, {name: 'Посещения', image:"/time.png"}]
...
const User: FC = () => {
    ...
    const fetchUser = async () => {
        try {
            await axiosInstance.get(`/auth/user/${pid}`).then( res => {
    ...
    useEffect(() => {
        ...
        return (
        <div className="mt-7 border-l border-gray-400 background-white flex flex-row gap-y-3 gap-x-7 w-4/5 px-4 py-4 bg-white">
